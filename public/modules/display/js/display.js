...
Component.options.__file = "modules\\display\\resources\\assets\\js\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73bb6e98", Component.options)
  } else {
    hotAPI.reload("data-v-73bb6e98", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_semantic_ui_vue__ = __webpack_require__(12);
...
Vue.component("index", __webpack_require__(19).default);
              ...
              _vm._l(_vm.tableList, function(list) {
                return _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("sui-table-cell", [_vm._v(_vm._s(list.defaultLayout))]),
                    _vm._v(" "),
                    _c("sui-table-cell", [_vm._v(_vm._s(list.lastAccessed))]),
                    _vm._v(" "),
                    _c("sui-table-cell", [_vm._v(_vm._s(list.clientAddress))]),
                    _vm._v(" "),
                    _c(
                      "sui-table-cell",
                      [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-73bb6e98", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_index_css__ = __webpack_require__(77);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    listLayout: function listLayout() {
      ...
      this.layoutData.forEach(function (l) {
        var newData = {
          text: l.layout,
          value: l.layoutId
        };
        _this.options.push(newData);
      });
      return this.options;
    }
  },
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("http://127.0.0.1:8000/display/data").then(function (res) {
      console.log(res.data);
      _this2.tableList = res.data;
    });

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("http://127.0.0.1:8000/display/layout").then(function (res) {
      console.log(res.data);
      _this2.layoutData = res.data;
    });
  },
  ...
  methods: {
    ...
    changeLayout: function changeLayout() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post("http://127.0.0.1:8000/display/setlayout", {
        layoutId: this.current,
        displayId: this.modalId
      }).then(function () {
        return _this3.modalIsOpen = false;
      }).then(function () {
        return __WEBPACK_IMPORTED_MODULE_1_sweetalert___default()("Saved!", "You've changed the Default Layout!", "success");
      }).then(function () {
        return _this3.refreshPage();
      });
    },
